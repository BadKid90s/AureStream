...
export default function SettingsPage() {
  ...
  return (
    <div className="relative flex flex-col w-full h-full max-w-[1080px] mx-auto animate-fade-in px-8 pt-6 pb-5 overflow-y-auto no-scrollbar gap-5">
      ...
      {/* Network & routing */}
      <div className="glass-card rounded-[24px] p-5 shadow-glass flex-1 flex flex-col min-h-[340px]">
        <SectionHeader
          icon={<I.Route />}
        ...
        <div className="mt-3 flex-1 flex flex-col min-h-0">
          ...
          <textarea
            ...
            className="w-full flex-1 min-h-[112px] p-4 rounded-2xl bg-surface-active/15 focus:ring-1 focus:ring-secondary/30 outline-none transition-all text-xs font-mono text-text resize-none shadow-inner no-scrollbar"
