...
function resolveNetworkInfo(ip?: string): NetworkInfo | null {
  ...
  const locations: NetworkInfo[] = [
    { ip, country: '香港 HK', city: '中环 Central', asn: 'AS20473', org: 'Vultr Holdings' },
    { ip, country: '日本 JP', city: '东京 Tokyo', asn: 'AS2497', org: 'IIJ Internet Initiative' },
    { ip, country: '新加坡 SG', city: '新加坡 Singapore', asn: 'AS14061', org: 'DigitalOcean LLC' },
    { ip, country: '美国 US', city: '洛杉矶 Los Angeles', asn: 'AS13335', org: 'Cloudflare Inc.' },
    { ip, country: '台湾 TW', city: '台北 Taipei', asn: 'AS3462', org: 'Chunghwa Telecom' },
  ]
