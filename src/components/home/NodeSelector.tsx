    ...
    <Card className="flex min-h-0 flex-1 flex-col rounded-[20px] overflow-hidden">
      <div className="flex items-center justify-between px-3 sm:px-4 pt-3.5 pb-2.5">
        <div className="flex items-center gap-1.5">
          <CardTitle className="text-xs sm:text-sm font-bold text-slate-800">选择代理节点</CardTitle>
              ...
              return (
                <label
                  ...
                  className={cn(
                    ...
                    isSelected
                      ? "bg-[#f4f7ff] border-[#bfdbfe]/60 shadow-[0_2px_8px_rgba(59,89,255,0.04)]"
                      : "bg-[#f8fafc]/30 border-slate-100 hover:bg-[#f8fafc]/60"
                  )}
                >
                  <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                    <div
                      className={cn(
                        ...
                        isSelected ? "bg-[#eef2ff] text-[#3b59ff]" : "bg-white text-slate-400 border border-slate-100"
                      )}
                    >
                    ...
                    <div className="min-w-0 flex-1">
                      <p
                        className={cn(
                          ...
                          isSelected ? "text-[#3b59ff]" : "text-slate-800"
                        )}
                      >
                        {node.name}
                      </p>
                  ...
                  <div className="flex items-center gap-3 ml-3 shrink-0">
                    ...
                    <RadioGroupItem
                      value={node.id}
                      id={`node-${node.id}`}
                      className="size-4 text-[#3b59ff] border-slate-300"
                    />
                  </div>
                </label>
              )
