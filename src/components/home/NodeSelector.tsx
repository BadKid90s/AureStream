...
export function NodeSelector() {
  const { nodes, loading } = useSubscriptions()
      ...
      <div className="flex items-center justify-between px-3 sm:px-4 pt-3.5 pb-2.5">
        ...
        <div className="flex gap-1.5">
          ...
          <Button
            variant="ghost"
            size="sm"
            className="h-8 px-3 rounded-lg bg-slate-100 text-slate-600 text-xs font-bold hover:bg-slate-200/60 dark:bg-white/[0.06] dark:text-white/70 dark:hover:bg-white/[0.1] transition-colors"
          >
