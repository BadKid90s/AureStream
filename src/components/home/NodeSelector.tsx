              ...
              return (
                <label
                  ...
                  className={cn(
                    ...
                    isSelected
                      ? "bg-[#f4f7ff] border-[#bfdbfe]/60 shadow-[0_2px_8px_rgba(59,89,255,0.04)] dark:bg-white/[0.04] dark:border-white/[0.08]"
                      : "bg-[#f8fafc]/30 border-slate-100 hover:bg-[#f8fafc]/60 dark:bg-white/[0.04] dark:border-white/[0.08] dark:hover:bg-white/[0.06]"
                  )}
                >
