    ...
    <Card className="shrink-0 border border-slate-100 rounded-[20px] shadow-sm">
      <CardContent className="flex flex-col gap-0 py-4 px-4">
        ...
        <div className="flex items-center justify-between gap-4 text-xs font-semibold">
          ...
          <span className="truncate text-slate-800 font-bold">113.88.208.31</span>
        </div>
        ...
        <div className="flex items-center justify-between gap-4 text-xs font-semibold">
          ...
          <span className="truncate text-slate-800 font-bold">广东 · 广州市</span>
        </div>
        ...
        <div className="flex items-center justify-between gap-4 text-xs font-semibold">
          ...
          <span className="truncate text-slate-800 font-bold">AS4134 · Chinanet</span>
        </div>
      </CardContent>
    </Card>
  )
