...
export function MainContent({ children }: MainContentProps) {
  return (
    <div className="flex-1 min-w-0 my-3 mr-3 rounded-3xl glass-rail overflow-hidden flex flex-col min-h-0 relative shadow-[inset_0_1px_0_rgba(255,255,255,0.4)] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
